...
inline std::vector<BandPreset> get_band_presets() {
    return {
        ...
        {"160m", 1825000,  1800000,  1850000,  200000},
        {"80m",  3550000,  3500000,  3600000,  200000},
        {"40m",  7033000,  7000000,  7125000,  200000},
        {"30m",  10125000, 10100000, 10150000, 200000},
        {"20m",  14050000, 14000000, 14150000, 200000},
        {"17m",  18085000, 18068000, 18110000, 200000},
        {"15m",  21050000, 21000000, 21200000, 200000},
        {"12m",  24910000, 24890000, 24930000, 200000},
        {"10m",  28050000, 28000000, 28300000, 200000},
    };
}
